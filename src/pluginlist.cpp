...
QStringList DummyPluginList::pluginNames() const
{
  return {};
}

IPluginList::PluginStates DummyPluginList::state(const QString &name) const
{
  return 0;
}

void DummyPluginList::setState(const QString &name, PluginStates state)
{
}

int DummyPluginList::priority(const QString &name) const
{
  return -1;
}

int DummyPluginList::loadOrder(const QString &name) const
{
  return -1;
}

void DummyPluginList::setLoadOrder(const QStringList &pluginList)
{
}
...
QStringList DummyPluginList::masters(const QString &name) const
{
  return {};
}

QString DummyPluginList::origin(const QString &name) const
{
  return {};
}

bool DummyPluginList::onRefreshed(const std::function<void()> &callback)
{
  return true;
}

bool DummyPluginList::onPluginMoved(const std::function<void (const QString &, int, int)> &func)
{
  return true;
}
