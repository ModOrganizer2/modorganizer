...
bool Settings::enableArchiveParsing() const
{
...
Settings::WorkaroundsTab::WorkaroundsTab(Settings *m_parent,
  ...
  , m_enableArchiveParsing_(m_dialog.findChild<QCheckBox *>("enableArchiveParsing"))
{
  ...
  m_enableArchiveParsing_->setChecked(m_parent->enableArchiveParsing());
...
void Settings::WorkaroundsTab::update()
{
  ...
  m_Settings.setValue("Settings/archive_parsing", m_enableArchiveParsing_->isChecked());
}
